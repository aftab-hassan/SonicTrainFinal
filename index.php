...
<div class="row">
	<a href="search.php">Search for a model</a>
...
if ( isset($_FILES["file"])) {
        ...
        if ($_FILES["file"]["error"] > 0) {
            ...
            $storagename = "uploadedinput.csv";
            move_uploaded_file($_FILES["file"]["tmp_name"], "uploads/" . $storagename);
            echo "Stored in: " . "uploads/" . "uploadedinput.csv" . "<br />";
        ...
        $row = 1;
if (($handle = fopen('uploads/'."uploadedinput.csv", "r")) !== FALSE) {
$fname="uploadedinput.csv";
?>
...
<?php
        $row = 1;
$file = 'uploads/defaultinput.csv';
$newfile = 'uploads/uploadedinput.csv';
...
if(!$_POST['submit']&&!$_POST['submit']){
	...
	print "Upload CSV file or <br> Click <input type='submit' name='abc' value='Here'> </form><br />\n";
